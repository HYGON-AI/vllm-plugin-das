...
- [ ] **Step 4: Implement phase-aware terminal validation**
...
- [ ] **Step 4: Run the new HY V4 tests and verify they fail**
...
- [ ] **Step 8: Run the full HY V4 attention test file**
...
- [ ] **Step 9: Commit the attention change**
...
- [ ] **Step 2: Run adjacent HY V4 and runner regressions**
...
- [ ] **Step 3: Compile changed Python files and check the diff**
...
- [ ] **Step 1: Confirm devices are idle**
...
- [ ] **Step 2: Start the exact service configuration**
...
- [ ] **Step 3: Poll readiness and exercise decode**
...
- [ ] **Step 4: Stop only the owned service tree**
...
- [ ] **Step 1: Restart or retain the validated service**

Use the exact Task 4 command and confirm `/health` succeeds immediately before evaluation.

- [ ] **Step 2: Run the eight deterministic HumanEval samples**
...
- [ ] **Step 3: Validate evaluation completeness and scores**
