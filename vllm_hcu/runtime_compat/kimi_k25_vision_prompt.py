...
"""Kimi K2.5 vision-chunk prompt compatibility for HCU."""
...
def install_kimi_k25_vision_prompt_compat() -> None:
    """Install string fallbacks for Kimi K2.5 vision-chunk prompts."""
