...
"""Strict helpers shared by worker op-optimization callbacks."""
...
class PatchCompatibilityError(RuntimeError):
    """The imported vLLM module does not expose the audited v0.21 API."""
...
def already_applied(
    ...
    """Validate idempotency markers and detect stale/reloaded targets."""
