...
_CORE_CALLBACKS: tuple[_CallbackSpec, ...] = (
    ...
    _CallbackSpec(_adapter("core_fix", "patch_deepseek_v41_dspark_load_weights")),
...
_OP_CALLBACKS: tuple[_CallbackSpec, ...] = (
    ...
    _CallbackSpec(_adapter("op_opt", "patch_sparse_mla_attention")),
    ...
    _CallbackSpec(_adapter("op_opt", "patch_compressed_tensors_moe_w8a8_int8")),
