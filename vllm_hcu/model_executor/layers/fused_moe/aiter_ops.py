...
"""HCU-owned vLLM v0.21 AITER operator module.

This is a complete cold replacement for :mod:`vllm._aiter_ops`.  That
upstream module registers Torch custom ops at import completion, so applying a
post-import wrapper would always be too late and could leave two owners for
the same schemas.  The implementation below retains the complete audited
v0.21 API and installs HCU callables before its single registration attempt.
"""
...
# ---------------------------------------------------------------------------
# HCU v0.21 integration.  Keep this immediately before the sole registration
